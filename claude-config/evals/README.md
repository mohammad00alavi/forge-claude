...
- Golden cases per capability — 14 suites: `assess.md`, `verifier.md`,
  `improve.md`, `fix.md`, `research.md`, `architect.md`, `forge.md`, `gtm.md`,
  `grill.md`, `maintain.md`, `brainstorm.md`, `improve-arch.md`,
  `automerge.md`, `forge-loop.md`. (`/start` is excluded — pure onboarding.)
